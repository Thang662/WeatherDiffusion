...
class RainDrop:
    ...
    def get_loaders(self, parse_patches=True, validation='raindrop'):
        ...
        train_dataset = RainDropDataset(dir=os.path.join(self.config.data.data_dir, 'train'),
                                        n=self.config.training.patch_n,
                                        patch_size=self.config.data.image_size,
                                        transforms=self.transforms,
                                        filelist=None,
                                        parse_patches=parse_patches)
        val_dataset = RainDropDataset(dir=os.path.join(self.config.data.data_dir, 'test_a'),
                                      n=self.config.training.patch_n,
                                      patch_size=self.config.data.image_size,
                                      transforms=self.transforms,
                                      filelist=None,
